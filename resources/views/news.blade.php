        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; align-items: center">
                    ...
                    <div>
                        <h2 style="margin: 30px 0 20px; font-size: 2em; font-weight: 900; text-align: center">Новости</h2>
                        <p style="width: 70%; min-width: 540px;">
                            <b>Информационные порталы, интересные мероприятия и события Санкт-Петербурга!</b>
                        </p>
                    </div>
                </div>
